...
<div class="emd-view">
  <a class="emd-view-back" href="../Horizontal_Grid_Cells/">← Back to all Horizontal Grid Cells</a>
...
(function () {
  ...
  var STEM       = "Horizontal_Grid_Cells";
  var SINGULAR   = "Grid Cell";
  var BADGE_TEXT = SINGULAR;
  var STAT_KEYS  = ["grid_type","n_cells","x_resolution","y_resolution","region","units"];       /* JSON list */
