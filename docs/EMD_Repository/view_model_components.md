...
<div class="emd-view">
  <a class="emd-view-back" href="../Model_Components/">← Back to all Model Components</a>
...
(function () {
  ...
  var STEM       = "Model_Components";
  var SINGULAR   = "Model Component";
  var BADGE_TEXT = SINGULAR;
  var STAT_KEYS  = ["component","family"];       /* JSON list */
