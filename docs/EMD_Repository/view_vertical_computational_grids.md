...
<div class="emd-view">
  <a class="emd-view-back" href="../Vertical_Computational_Grids/">← Back to all Vertical Computational Grids</a>
...
(function () {
  ...
  var STEM       = "Vertical_Computational_Grids";
  var SINGULAR   = "Vertical Grid";
  var BADGE_TEXT = SINGULAR;
  var STAT_KEYS  = ["vertical_coordinate","n_z","total_thickness","top_layer_thickness","bottom_layer_thickness"];       /* JSON list */
