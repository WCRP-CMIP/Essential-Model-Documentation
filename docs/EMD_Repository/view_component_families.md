...
<div class="emd-view">
  <a class="emd-view-back" href="../Component_Families/">← Back to all Component Families</a>
...
(function () {
  ...
  var STEM       = "Component_Families";
  var SINGULAR   = "Component Family";
  var BADGE_TEXT = SINGULAR;
  var STAT_KEYS  = ["primary_institution","established","license"];       /* JSON list */
