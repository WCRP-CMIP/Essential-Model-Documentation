...
function addFloatingExpandButton() {
    ...
    Object.assign(button.style, {
        ...
        width: '50px',
        height: '50px',
        background: 'var(--essentialmodeldocumentation-primary, #3b82f6)',
        color: 'white',
        border: 'none',
        borderRadius: '50%',
        fontSize: '1.5rem',
...
function addTableControls(table, index) {
    ...
    Object.assign(searchInput.style, {
        padding: '8px 12px',
        border: '1px solid var(--essentialmodeldocumentation-border, #e2e8f0)',
        borderRadius: '6px',
        fontSize: '0.875rem',
        width: '250px',
        maxWidth: '100%',
        marginBottom: '10px',
        background: 'var(--essentialmodeldocumentation-bg, white)',
        color: 'var(--essentialmodeldocumentation-text, #1e293b)'
    });
    ...
    Object.assign(expandBtn.style, {
        ...
        border: '1px solid var(--essentialmodeldocumentation-border, #e2e8f0)',
        borderRadius: '6px',
        background: 'var(--essentialmodeldocumentation-bg-secondary, #f8fafc)',
        cursor: 'pointer',
        marginLeft: '10px',
        fontSize: '1rem'
    });
...
function expandTable(table) {
    ...
    Object.assign(searchInput.style, {
        padding: '8px 12px',
        border: '1px solid var(--essentialmodeldocumentation-primary, #3b82f6)',
        borderRadius: '6px',
        fontSize: '0.875rem',
        width: '250px',
        maxWidth: '100%',
