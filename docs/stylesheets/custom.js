...
function createNestedFolder(parentMenu, folder, baseUrl) {
  ...
  header.style.cssText = `
    ...
    font-size: 0.8rem;
    font-weight: 500;
    color: var(--essentialmodeldocumentation-text-secondary);
    border-radius: 6px;
  ...
  folder.children.forEach(child => {
    ...
    if (isActive) {
      link.style.color = 'var(--essentialmodeldocumentation-primary)';
      link.style.fontWeight = '600';
      hasActive = true;
    }
    
    link.addEventListener('mouseenter', () => {
      link.style.background = 'var(--essentialmodeldocumentation-bg-secondary)';
      link.style.color = 'var(--essentialmodeldocumentation-text)';
    });
    
    link.addEventListener('mouseleave', () => {
      link.style.background = 'transparent';
      link.style.color = isActive ? 'var(--essentialmodeldocumentation-primary)' : 'var(--essentialmodeldocumentation-text-secondary)';
    });
  ...
  header.addEventListener('mouseenter', () => {
    header.style.background = 'var(--essentialmodeldocumentation-bg-secondary)';
    header.style.color = 'var(--essentialmodeldocumentation-text)';
  });
  
  header.addEventListener('mouseleave', () => {
    header.style.background = 'transparent';
    header.style.color = 'var(--essentialmodeldocumentation-text-secondary)';
  });
