...
| **JSON-LD** | [`emd:horizontal_grid_cells`](https://emd.wcrp-cmip.org/horizontal_grid_cells) |
...
- JSON: [`https://emd.wcrp-cmip.org/horizontal_grid_cells/g100.json`](https://emd.wcrp-cmip.org/horizontal_grid_cells/g100.json)
