...
- **Component**: `land_surface_CLM4.json`
...
**Files**:
- `model-component/land_surface_CLM4.json`
...
- **Component**: `land_ice_BISICLES-UKESM-ISMIP6-1.0.json`
- **Family**: BISICLES
...
**Files**:
- `model-component/land_ice_BISICLES-UKESM-ISMIP6-1.0.json`
...
- File naming uses `EX_` prefix to distinguish examples from production data
- All @id values use lowercase with underscores converted to hyphens
