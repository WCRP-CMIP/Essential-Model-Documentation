...
// Per-realm label + accent colour, shared across the page.
export const REALM_META = {
  "atmosphere":            { label: "Atmosphere",             color: "#3b82c4" },
  "atmospheric-chemistry": { label: "Atmospheric chemistry",  color: "#7aa5d2" },
  "aerosol":               { label: "Aerosol",                color: "#9db8d8" },
  "land-surface":          { label: "Land surface",           color: "#4c9a6a" },
  "land-ice":              { label: "Land ice",               color: "#8fb8c9" },
  "ocean":                 { label: "Ocean",                  color: "#2f6f9f" },
  "ocean-biogeochemistry": { label: "Ocean biogeochemistry",  color: "#3f8f8f" },
  "sea-ice":               { label: "Sea ice",                color: "#6bb0c4" },
};
